        ...
        <table class="table">
            ...
            <c:forEach var="cliente" items="${usuarios}">
                <tr>
                    ...
                    <td>
                        <a class="btn btn-warning" href="controlador?menu=Empleados&accion=Cargar&id=${cliente.getId()}" >Editar</a>
                        <a class="btn btn-danger" href="controlador?menu=Empleados&accion=Eliminar&id=${cliente.getId()}">Eliminar</a>
