        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="ventas">
                    ...
                    <div class="row">
                        <div class="col-md-8 d-flex">
                            <input type="number" name="cantidadDias" class="form-control" placeholder="ingrese dias" >

                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-8 d-flex">
                            <input type="number" name="cantidadPersonas" class="form-control" placeholder="¿Cutas personas?" >
            ...
            <div class="card-body">
                <form action="Controlador?menu=Ventas" method="post">
                    <div class="row">
                        ...
                        <div class="col-md-4 d-flex form-group">
                            <input type="text" name="precioproducto" class="form-control" placeholder="$ 0000.00">
                        </div>
                        <div class="col-md-8 d-flex form-group">
                            <input type="number" value="1" name="cantidadproducto" class="form-control" placeholder="Cantidad">
                        </div>
                    </div>
                    <input type="submit" name="accion" value="Listar" class="btn btn-outline-primary col text-center">
                    <div class="row"></div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table">
                    ...
                    <tr>
                        <th scope="row">${ventas.getIdVenta()}</th>
                        <td>${ventas.getNumeroFactura()}</td>
                        <td>${ventas.getIdproducto()}</td>
                        <td>${ventas.getTotalVenta()}</td>
                        <td>${ventas.getFecha()}</td>
                        <td>${ventas.getIdEmpleado()}</td>
                    </tr>
                    </c:forEach>
